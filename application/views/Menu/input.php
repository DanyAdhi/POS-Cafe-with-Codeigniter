  ...
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
          ...
          <form method="post" action="<?=base_url($i.'menu/input_save')?>" enctype="multipart/form-data">
              ...
              <div class="col-md-12 ml-3">
                <div class="form-check">
                  <label class="form-check-label">
                    <input class="form-check-input" type="radio" name="jenis" id="Makanan" value="Makanan" <?=($object['type']!='Minuman')?'checked':'' ?>>Makanan
                  </label>
                </div>
                <div class="form-check">
                  <label class="form-check-label">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="input-group " style="width: 170px">
                  <input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"  type="text" placeholder="20.000" name="harga" value="<?=$object['price']?>" onkeypress="return hanyaAngka(event)">
